...
class FaqController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.faq.index')->with(compact('title','faqs'));
    }
    ...
    public function addfaq()
    {
        ...
        return view('admin.faq.addfaq')->with(compact('title'));
    }
    ...
    public function editfaq($id)
    {
        ...
        return view('admin.faq.updatefaq')->with(compact('title','faq'));
    }
