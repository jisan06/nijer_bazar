...
class DebitEntryController extends Controller
{
    ...
    public function print(Request $request)
    {
        ...
        $pdf = PDF::loadView('admin.debitEntry.print',['title'=>$title,'fromDate'=>$fromDate,'toDate'=>$toDate,'print'=>$print,'transactionLists'=>$transactionLists],[],['orientation'=>'P']);
    ...
    public function add()
    {
    	...
    	return view('admin.debitEntry.add')->with(compact('title','formLink','buttonName','showrooms','coas','creditCoas'));
    }
    ...
    public function printDebitVoucher($debitEntryId)
    {
        ...
        $pdf = PDF::loadView('admin.debitEntry.printDebitVoucher',['title'=>$title,'debitEntry'=>$debitEntry,'debitEntries'=>$debitEntries],[],['orientation'=>'P']);
        return $pdf->stream('debit_voucher_'.$debitEntry->voucher_no.'.pdf');    	
    }

    public function findDebitInfo($debitEntryId)
    {
        $debitEntry = DebitEntry::select('tbl_account_transactions.*','tbl_showroom.name as showroomName','tbl_coa.head_name as creditHeadName')
