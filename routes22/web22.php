...
Route::prefix('admin')->group(function()
{
	...
	Route::group(['middleware'=>'menuPermission'],function(){
		...
		Route::get('/charge/status/{id}', 'Admin\ShippingChargeController@shippingChargeStatus')->name('shippingCharge.shippingChargeStatus');
		...
		Route::get('/customer-group-add', 'Admin\CustomerGroupController@addCustomerGroup');
		Route::post('/save-customer-group', 'Admin\CustomerGroupController@saveCustomerGroup');
		Route::get('/charge/status/{id}', 'Admin\CustomerGroupController@shippingChargeStatus')->name('shippingCharge.shippingChargeStatus');

		Route::get('/edit-customer-group/{id}', 'Admin\CustomerGroupController@edit');

		Route::post('/update-customer-group', 'Admin\CustomerGroupController@updateCustomerGroup');

		Route::get('/shipping-charge-delete/{id}', 'Admin\CustomerGroupController@deleteCharge')->name('shippingCharge.delete');
		Route::post('/shipping-charge-delete', 'Admin\CustomerGroupController@destroy')->name('shippingCharges.deletes');
		...
		*/
		...
		Route::get('/checkouts/{id}/shipping', 'Admin\CheckoutController@shipping')->name('checkouts.shipping');
		/*Route::get('/checkouts/{id}/status', 'Admin\CheckoutController@status')->name('checkouts.status');*/
		


		Route::get('/contactUses/{id}/delete', 'ContactUsController@delete');
		Route::get('/contactUses/{id}/starred', 'ContactUsController@starred');
		Route::get('/contactUses/{id}/seen', 'ContactUsController@seen');
		Route::get('/contactUses/{id}/unseen', 'ContactUsController@unseen');
		Route::resource('contactUses', 'ContactUsController');
		Route::resource('careers', 'CareerController');

		Route::get('/settings/mds_message', 'HomeController@message_md')->name('settings.message_md');
		Route::post('/settings/mds_message', 'HomeController@message_md_ajax')->name('settings.message_md');
