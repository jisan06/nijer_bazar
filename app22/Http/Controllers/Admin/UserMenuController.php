...
class UserMenuController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.usermenus.index')->with(compact('menus'));
    }

    public function add(){
        $menus = UserMenu::where('menuStatus',1)->get();
        return view('admin.usermenus.add')->with(compact('menus'));
    }
     ...
     public function edit($id){
        ...
        $menus = UserMenu::where('menuStatus',1)->get();
        return view('admin.usermenus.edit')->with(compact('menus','menuItem'));
    }
    ...
    public function usermenuLink($menuId)
    {
        ...
        return view('admin.usermenus.usermenuLink')->with(compact('menus','menuId'));
    }

    public function usermenuLinkAdd($menuId){
        $menus = UserMenu::where('menuStatus',1)->get();
        return view('admin.usermenus.usermenuLinkAdd')->with(compact('menus','menuId'));
    }
