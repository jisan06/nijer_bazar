...
class CustomerGroupController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.CustomerGroup.index')->with(compact('customer_groups'));
    }
    ...
    public function status(Request $request)
    {
     ...
     public function addCustomerGroup(){
        return view('admin.customerGroup.add');
    }
    ...
    public function edit($id){
        ...
        return view('admin.customerGroup.edit')->with(compact('customer_group'));
    }
