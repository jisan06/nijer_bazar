...
class ShippingChargeController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.shippingCharges.index')->with(compact('shippingCharges'));
    }
    ...
    public function shippingChargeStatus(Request $request)
    {
     ...
     public function addcharge(){
        return view('admin.shippingCharges.addcharge');
    }
    ...
    public function editCharge($id){
        ...
        return view('admin.shippingCharges.updatecharge')->with(compact('shipping_charges'));
    }
