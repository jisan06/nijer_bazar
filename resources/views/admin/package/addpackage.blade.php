...
<div class="row">
    ...
    <div class="">        
        <div class="">
            ...
            <form class="form-horizontal" action="{{route('package.save')}}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            ...
            <div class="modal-body">
                ...
                <div class="form-group row {{ $errors->has('packageName') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-danger" placeholder="Write package name" name="packageName" value="{{ old('packageName') }}" required>
                ...
                <div class="col-md-12 m-b-20 text-right">    
                    <button type="submit" class="btn btn-info waves-effect">Save Package</button> 
                </div>
            </div>                
            </form>
        </div>
