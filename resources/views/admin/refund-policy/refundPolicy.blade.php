...
<div class="row">
    ...
    <div class="">        
        <div class="">
            ...
            <form class="form-horizontal" action="{{route('refundPolicy.update')}}" method="POST" enctype="multipart/form-data" name="editAbout">
            {{ csrf_field() }}

                <input type="hidden" name="refundpolicyID" value="{{$refundPolicy->id}}">
                ...
                <div class="form-group row {{ $errors->has('title') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-danger" placeholder="Title" name="title" value="{{ $refundPolicy->title  }}" required>
                        @if ($errors->has('name'))
                 ...
                 <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <textarea class="summernote form-control form-control-danger" name="description" required>{{ $refundPolicy->description }}</textarea>
                ...
                <div class="form-group row {{ $errors->has('metaTitle') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-danger" placeholder="Meta Title" name="metaTitle" value="{{ @$refundPolicy->metaTitle }}">
                ...
                <div class="form-group row {{ $errors->has('metaKeyword') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-danger" placeholder="Meta Keyword" name="metaKeyword" value="{{ @$refundPolicy->metaKeyword }}">
                ...
                <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <textarea style="min-height: 100px;" class="form-control" name="metaDescription">{{ @$refundPolicy->metaDescription }}</textarea>
    ...
    <script type="text/javascript">
        ...
        document.forms['editAbout'].elements['status'].value = "{{$refundPolicy->status}}";
