                ...
                <div class="row">
                    ...
                    <div class="col-md-6">  
                        <span class="shortlink">
                            <a style=" font-size: 16px;" class="btn btn-outline-info btn-lg" href="{{ route('chargeadd.page')}}">
                ...
                ?>
                    <table id="categoriesTable" class="table table-bordered table-striped"  name="categoriesTable">
                        ...
                        <tbody id="tbody">
                        	...
                        	<tr>
                                <td>{{ $i++ }}</td>
                                <td>{{ $charge->shippingAmount }}</td>
                                <td>{{ $charge->shippingCharge }}</td>
                                <td> 
                                    <?php
                                        if ($charge->shippingLocation == "inside") {
                                             echo "Inside Dhaka";
                                         } else{
                                            echo "Outside Dhaka";
                                         }
