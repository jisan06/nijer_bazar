			...
			<div class="card" style="margin-bottom: 200px;">
				...
				<div class="card-body">
					...
					<div class="modal-body">
						<form class="form-horizontal" action="{{ route('cashSale.save') }}" method="post" enctype="multipart/form-data">
							{{ csrf_field() }}
                                    ...
                                    <table class="table table-bordered table-striped gridTable" >
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <th>Customer Paid</th>
                                                <td>
                                                    <input style="text-align: right;" class="customer_paid" type="number" name="customer_paid" oninput="netAmount()">
                                                </td>
                                            </tr>
