    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    @php
                        $productSections = array('1'=>'New Arrival','2'=>'Featured Product','3'=>'Top Rated','4'=>'Best Seller');
                    ...
                    <div class="form-group" style="height: 40px; line-height: 40px;">
                        <div class="form-check-inline">
                            <label class="form-check-label" for="free_shipping">
                                <input class="form-check-input" type="checkbox" name="free_shipping" value="free" {{ @$productAdvance->free_shipping == "free" ? 'checked' : '' }}>Free Shipping
                            </label>
                        </div>
                    </div>
                </div>
