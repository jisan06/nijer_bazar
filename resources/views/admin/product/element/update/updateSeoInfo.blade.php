            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('metaTitle') ? ' has-danger' : '' }}">
                        <input type="text" class="form-control form-control-danger" name="metaTitle" value="{{ $product->metaTitle }}" required>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group {{ $errors->has('metaKeyword') ? ' has-danger' : '' }}">
                        <input type="text" class="form-control form-control-danger" data-role="tagsinput" name="metaKeyword" value="{{ $product->metaKeyword }}" required>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group {{ $errors->has('metaDescription') ? ' has-danger' : '' }}">
                        <textarea class="form-control" name="metaDescription" rows="5" required>{{ $product->metaDescription }}</textarea>
