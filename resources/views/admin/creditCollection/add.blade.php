			...
			<div class="card" style="margin-bottom: 200px;">
				...
				<div class="card-body">
					...
					<div class="modal-body">
						<form class="form-horizontal" action="{{ route('creditCollection.save') }}" method="post" enctype="multipart/form-data">
							{{ csrf_field() }}
							...
							<div class="row">
								<div class="col-md-6">
	                                <div class="form-group {{ $errors->has('payment_no') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="payment_no" name="payment_no" value="" required readonly/>
								...
								<div class="col-md-6">
	                                <div class="form-group {{ $errors->has('payment_date') ? ' has-danger' : '' }}">
	                                    ...
	                                    <input  type="text" class="form-control add_datepicker" id="payment_date" name="payment_date" readonly>
							...
							<div class="row">
								<div class="col-md-6">
	                                <div class="form-group {{ $errors->has('money_receipt_no') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="text" class="form-control" id="money_receipt_no" name="money_receipt_no" value="" required/>
							...
							<div class="row">
								<div class="col-md-6">
	                                <div class="form-group {{ $errors->has('due_amount') ? ' has-danger' : '' }}">
                                        ...
                                        <input type="number" class="form-control" id="due_amount" name="due_amount" value="" required readonly />
									...
									<div class="row">
										<div class="col-md-6">
			                                <div class="form-group {{ $errors->has('new_paid') ? ' has-danger' : '' }}">
		                                        ...
		                                        <input type="text" class="form-control" id="new_paid" name="new_paid" value="" required/>
