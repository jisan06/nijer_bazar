...
<div class="row">
    ...
    <span class="shortlink">
         <a class="btn btn-info"  href="{{ route('banners.index') }}">Go Back</a>
         <a class="btn btn-info" onclick="return confirm('Are you sure want to delete')"  href="{{ route('banner.delete',$banners->id) }}">Delete</a>
         <a class="btn btn-info"  href="{{ route('banneradd.page') }}">Add New</a>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" name="bannerId" value="{{$banners->id}}">
                 ...
                 <div class="form-group row {{ $errors->has('bannerImage') ? ' has-danger' : '' }}">
                    <label for="inputHorizontalDnger" class="col-sm-3 col-form-label">anner Image</label>
                    <div class="col-sm-9">
                        <input type="file" class="form-control form-control-danger" placeholder="Category image" name="bannerImage">
