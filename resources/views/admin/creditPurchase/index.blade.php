                    ...
                    <div class="table-responsive">
                        <table id="dataTable" class="table table-bordered table-striped"  name="dataTable">
                            ...
                            <tbody id="tbody">
                            	...
                            	@foreach($creditPurchase as $purchase)
                                    @php
                                        $sl++;
                                        $submission_date = Date('d-m-Y',strtotime($purchase->submission_date)); 
                                     @endphp                   	
                                	<tr>
                                        <td>{{ $sl }}</td>
                                        <td>{{ $purchase->id }}</td>
                                        <td>{{ $purchase->credit_serial }}</td>
                                        <td>{{ $purchase->vouchar_no }}</td>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#dataTable tbody').on( 'click', 'i.fa-trash', function () {
                ...
                creditPurchaseId = $(this).parent().data('id');
                var tableRow = this;
                swal({   
                    title: "Are you sure?",   
                    ...
                    if (isConfirm) {     
                       $.ajax({
                            type: "POST",
                           url : "{{ route('creditPurchase.destroy') }}",
                            data : {creditPurchaseId:creditPurchaseId},
