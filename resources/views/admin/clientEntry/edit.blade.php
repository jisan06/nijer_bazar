			...
			<div class="card" style="margin-bottom: 200px;">
				...
				<div class="card-body">
					...
					<div class="modal-body">
						<form class="form-horizontal" action="{{ route('clientEntry.update') }}" method="post" enctype="multipart/form-data">
							{{ csrf_field() }}
							...
							<div class="row">
								<div class="col-md-6">
	                                <div class="form-group {{ $errors->has('dob') ? ' has-danger' : '' }}">
	                                    ...
	                                    <input type="text" class="form-control edit_birth_datepicker" id="dob" value="{{ date('d-m-Y', strtotime($customer->dob)) }}" name="dob" placeholder="Select Your Date Of Birth">
	                                    @if ($errors->has('dob'))
