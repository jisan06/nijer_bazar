...
<div class="row">
    ...
    <div class="">        
        <div class="">
            ...
            <form class="form-horizontal" action="{{route('paymentPolicy.update')}}" method="POST" enctype="multipart/form-data" name="editAbout">
            {{ csrf_field() }}
                ...
                <div class="form-group row {{ $errors->has('title') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-danger" placeholder="Title" name="title" value="{{ $paymentPolicy->title  }}" required>
                        @if ($errors->has('name'))
                 ...
                 <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <textarea class="summernote form-control form-control-danger" name="description" required>{{ $paymentPolicy->description }}</textarea>
                ...
                <div class="form-group row {{ $errors->has('metaTitle') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-danger" placeholder="Meta Title" name="metaTitle" value="{{ @$paymentPolicy->metaTitle }}">
                ...
                <div class="form-group row {{ $errors->has('metaKeyword') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-danger" placeholder="Meta Keyword" name="metaKeyword" value="{{ @$paymentPolicy->metaKeyword }}">
                ...
                <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <textarea style="min-height: 100px;" class="form-control" name="metaDescription">{{ @$paymentPolicy->metaDescription }}</textarea>
    ...
    <script type="text/javascript">
        ...
        document.forms['editAbout'].elements['status'].value = "{{$paymentPolicy->status}}";
