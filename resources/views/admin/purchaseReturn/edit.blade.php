                ...
                <div class="col-md-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group {{ $errors->has('purchase_return_serial') ? ' has-danger' : '' }}">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group {{ $errors->has('purchase_return_date') ? ' has-danger' : '' }}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group {{ $errors->has('remarks') ? ' has-danger' : '' }}">
                                <textarea class="form-control form-control-danger" name="remarks" rows="5">{{$purchaseReturn->remarks}}</textarea>
                                ...
                                <table width="95%" class="table table-bordered table-striped gridTable" >
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                                <input class="total_qty" type="number" name="total_qty" value="{{$purchaseReturn->total_qty}}" readonly>
                                            </td>
                                            <th>Total Amount</th>
                                            <td>
                                                <input class="total_amount" type="number" name="total_amount" value="{{$purchaseReturn->total_amount}}" readonly>
                                            </td>
