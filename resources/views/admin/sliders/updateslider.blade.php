...
<div class="row">
    ...
    <span class="shortlink">
         ...
         <a class="btn btn-info" onclick="return confirm('Are you sure want to delete')"  href="{{ route('slider.delete',$sliders->id) }}">Delete</a>
                ...
                <input type="hidden" name="sliderId" value="{{$sliders->id}}">
                 ...
                 <div class="form-group row {{ $errors->has('sliderImage') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        ...
                        <img src="{{ asset('/').$sliders->source }}" style="height: 85px" alt="You Have No Image">
                    </div>
