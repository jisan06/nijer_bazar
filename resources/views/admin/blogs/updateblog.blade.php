...
<div class="row">
    ...
    <span class="shortlink">
         ...
         <a class="btn btn-info" onclick="return confirm('Are you sure want to delete')"  href="{{ route('blog.delete',$blogs->id) }}">Delete</a>
         <a class="btn btn-info"  href="{{ route('blogadd.page') }}">Add New</a>
    ...
    <div class="">        
        <div class="">
            ...
            <form class="form-horizontal" action="{{ route('blog.update') }}" method="POST" enctype="multipart/form-data" id="editBlog" name="editBlog">
            {{ csrf_field() }}
        ...
        @endif
            <div class="modal-body">
                ...
                <div class="form-group row {{ $errors->has('title') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-danger" placeholder="Blog title" name="title" value="{{ $blogs->title }}" required>
                        @if ($errors->has('title'))
                ...
                <div class="form-group row {{ $errors->has('blogImage') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="file" class="form-control form-control-danger" placeholder="Blog Image" name="blogImage" value="{{ $blogs->title }}">
                        @if ($errors->has('blogImage'))
                        @foreach($errors->get('blogImage') as $error)
                        <div class="form-control-feedback">{{ $error }}</div>
                        @endforeach
                        @endif
                         <img src="{{ asset('/').$blogs->blogImage }}" style="height: 85px" alt="You Have No Image">
                    </div>
                </div>
                 ...
                 <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                       <textarea name="description" class="form-control" style="min-height: 400px;" required>{{ $blogs->description }}</textarea>
                    </div>
                </div>
                ...
                <div class="form-group row {{ $errors->has('metaTitle') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-danger" placeholder="Meta Title" name="metaTitle" value="{{ $blogs->metaTitle }}"">
                ...
                <div class="form-group row {{ $errors->has('metaKeyword') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-danger" placeholder="Meta Keyword" name="metaKeyword" value="{{ $blogs->metaKeyword }}">
                ...
                <div class="form-group row {{ $errors->has('description') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <textarea style="min-height: 100px;" class="form-control" name="metaDescription">{{ $blogs->metaDescription }}</textarea>
                 ...
                 <div class="form-group row {{ $errors->has('orderBy') ? ' has-danger' : '' }}">
                    ...
                    <div class="col-sm-9">
                        <input type="number"   name="orderBy" value="{{ $blogs->orderBy }}" required>
...
<script type="text/javascript">
    document.forms['editBlog'].elements['status'].value = "{{$blogs->status}}";
