			...
			<div class="card" style="margin-bottom: 0px;">
				...
				<div class="card-body">
					...
					<div class="modal-body">
						<form class="form-horizontal" action="{{ route('purchaseHistory.index') }}" method="post" enctype="multipart/form-data">
							{{ csrf_field() }}
							...
							<div class="row">
								...
								@php
									$type = array('Cash' => 'Cash', 'Credit' => 'Credit')
								@endphp

								<div class="col-md-6">
                                    <label for="client">Purchase Type</label>
                                    <div class="form-group">
                                    	<select class="form-control chosen-select" id="purchase_type" name="purchase_type[]" multiple>
				...
				<div class="card-header">
					<div class="row">
						...
						<div class="col-md-6 text-right">
							<form class="form-horizontal" action="{{ route('purchaseHistory.print') }}" target="_blank" method="post" enctype="multipart/form-data">
								{{ csrf_field() }}
